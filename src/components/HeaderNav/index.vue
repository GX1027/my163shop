...
<template>
  <header class="header_box">
    <div class="header_search">
      <img
        :src="
          'http://yanxuan-static.nosdn.127.net/hxm/yanxuan-wap/p/20161201/style/img/icon-normal/indexLogo-a90bdaae6b.png'
        "
        alt="网易严选"
      />
      <div class="search_box" @click="$router.push('/search')">
        <img
          :src="
            'http://yanxuan-static.nosdn.127.net/hxm/yanxuan-wap/p/20161201/style/img/icon-normal/search2-553dba3aff.png'
          "
          alt="放大镜"
        />
        <span class="placeholder">搜索商品，共23456件好物</span>
      </div>
      ...
      <div class="right_span">
        ...
        <div class="img_box">
          <img
            ...
            :src="
              'http://yanxuan-static.nosdn.127.net/hxm/yanxuan-wap/p/20161201/style/img/icon-normal/arrow-down-3-799ded53ea.png'
            "
            alt="展开"
          />
        </div>
...
export default {
  ...
  methods: {
    addActive(event) {
      this.curA = +event.target.dataset.thisIndex
    }
  }
}
</script>
