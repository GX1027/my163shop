...
<template>
  <footer id="footer_box">
    <ul class="footer_nav">
      ...
      <li
        class="item"
        :class="{ active: $route.path.includes('/category') }"
      ...
      <li
        class="item"
        :class="{ active: $route.path.includes('/things') }"
        @click="$router.replace('/things')"
      >
        <i
          class="u-icon"
          :class="
            $route.path.includes('/things')
