...
<template>
  <div class="email_login_box">
    ...
    <label for="email" class="input_email">
      <div class="login_tips">
        <p v-show="email_tips">{{ email_tips }}</p>
        <p v-show="password_tips">{{ password_tips }}</p>
      </div>
      <input
        type="text"
        id="email"
    ...
    <label for="password" class="input_code">
      <input
        type="password"
        placeholder="请输入密码"
        id="password"
    ...
    <div class="register_btn">其他登录方式 &gt;</div>
  </div>
</template>
